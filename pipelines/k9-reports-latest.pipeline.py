{
    'filter': {
        'query': 'host:("arn:aws:s3:::k9-reports-dev" OR '
    ...
    'processors': [
        {'grok': {'match_rules': 'parse_filename_metadata '
         ...
         'type': 'grok-parser'},
        {'is_enabled': True,
         'name': 'Set analysis_time k9 report attribute to official '
                 'timestamp',
         'sources': ['analysis_time'],
         'type': 'date-remapper'},
        {'is_enabled': True,
        ...
        {'filter': {'query': '@k9.report.type:"principal-access-summaries"'},
         ...
         'processors': [{'grok': {'match_rules': 'principal_tag_rule '
                         ...
                         'type': 'grok-parser'},
                        {'grok': {'match_rules': 'k9_principal_access_summary_rule '
        ...
        {'filter': {'query': '@k9.report.type:"principals"'},
         ...
         'processors': [{'grok': {'match_rules': 'k9_principals_summary_rule '
                         ...
                         'samples': [
                             '2022-12-10T07:14:19.753800+00:00,ci,arn:aws:iam::139710491120:user/ci,IAMUser,True,2022-12-10 '
        ...
        {'filter': {'query': '@k9.report.type:"resources"'},
         ...
         'processors': [{'grok': {'match_rules': 'k9_resource_access_summary_rule '
                                                 '%{data:resources:csv("analysis_time,resource_name,resource_arn,resource_type,resource_tag_business_unit,resource_tag_environment,resource_tag_owner,resource_tag_confidentiality,resource_tag_integrity,resource_tag_availability,resource_tags")}',
                                  'support_rules': ''},
                         'is_enabled': True,
